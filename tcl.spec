...
Source0  : https://sourceforge.net/projects/tcl/files/Tcl/8.6.14/tcl8.6.14-src.tar.gz
Summary  : Tcl scripting language development environment
Group    : Development/Tools
License  : BSL-1.0 TCL Zlib
...
Requires: tcl-staticdev = %{version}-%{release}
...
%prep
%setup -q -n tcl8.6.14
cd %{_builddir}/tcl8.6.14
%patch -P 1 -p1
pushd ..
cp -a tcl8.6.14 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720023923
...
cp %{_builddir}/tcl%{version}/compat/zlib/LICENSE %{buildroot}/usr/share/package-licenses/tcl/233f44af3fb55dcc7fddfef8e77ac627b0008756 || :
...
cp %{_builddir}/tcl%{version}/pkgs/itcl4.2.4/license.terms %{buildroot}/usr/share/package-licenses/tcl/0694c44c6528f38ba02518028ae540be0daffc82 || :
cp %{_builddir}/tcl%{version}/pkgs/tdbc1.1.7/license.terms %{buildroot}/usr/share/package-licenses/tcl/af1bb3f2eb2888c6a0cb73a32f12b2f599f9cd1f || :
cp %{_builddir}/tcl%{version}/pkgs/tdbcmysql1.1.7/license.terms %{buildroot}/usr/share/package-licenses/tcl/af1bb3f2eb2888c6a0cb73a32f12b2f599f9cd1f || :
cp %{_builddir}/tcl%{version}/pkgs/tdbcodbc1.1.7/license.terms %{buildroot}/usr/share/package-licenses/tcl/af1bb3f2eb2888c6a0cb73a32f12b2f599f9cd1f || :
cp %{_builddir}/tcl%{version}/pkgs/tdbcpostgres1.1.7/license.terms %{buildroot}/usr/share/package-licenses/tcl/4cf449426b4a1f7696cb04e69ac100f262f5a715 || :
cp %{_builddir}/tcl%{version}/pkgs/tdbcsqlite3-1.1.7/license.terms %{buildroot}/usr/share/package-licenses/tcl/05c2120a6b8f992414f673c68a562cdf560f46e3 || :
cp %{_builddir}/tcl%{version}/pkgs/thread2.8.9/license.terms %{buildroot}/usr/share/package-licenses/tcl/44869749a0261aabc6d26adb33554b24f9b017c2 || :
...
/usr/lib64/itcl4.2.4/itcl.tcl
/usr/lib64/itcl4.2.4/itclConfig.sh
/usr/lib64/itcl4.2.4/itclHullCmds.tcl
/usr/lib64/itcl4.2.4/itclWidget.tcl
/usr/lib64/itcl4.2.4/libitclstub4.2.4.a
/usr/lib64/itcl4.2.4/pkgIndex.tcl
/usr/lib64/sqlite3.44.2/pkgIndex.tcl
/usr/lib64/tcl8/8.6/tdbc/sqlite3-1.1.7.tm
/usr/lib64/tclConfig.sh
/usr/lib64/tclooConfig.sh
/usr/lib64/tdbc1.1.7/libtdbcstub1.1.7.a
/usr/lib64/tdbc1.1.7/pkgIndex.tcl
/usr/lib64/tdbc1.1.7/tdbc.tcl
/usr/lib64/tdbc1.1.7/tdbcConfig.sh
/usr/lib64/tdbcmysql1.1.7/pkgIndex.tcl
/usr/lib64/tdbcmysql1.1.7/tdbcmysql.tcl
/usr/lib64/tdbcodbc1.1.7/pkgIndex.tcl
/usr/lib64/tdbcodbc1.1.7/tdbcodbc.tcl
/usr/lib64/tdbcpostgres1.1.7/pkgIndex.tcl
/usr/lib64/tdbcpostgres1.1.7/tdbcpostgres.tcl
/usr/lib64/thread2.8.9/pkgIndex.tcl
/usr/lib64/thread2.8.9/ttrace.tcl
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/itcl4.2.4/libitcl4.2.4.so
/V3/usr/lib64/libtcl8.6.so
/V3/usr/lib64/sqlite3.44.2/libsqlite3.44.2.so
/V3/usr/lib64/tdbc1.1.7/libtdbc1.1.7.so
/V3/usr/lib64/tdbcmysql1.1.7/libtdbcmysql1.1.7.so
/V3/usr/lib64/tdbcodbc1.1.7/libtdbcodbc1.1.7.so
/V3/usr/lib64/tdbcpostgres1.1.7/libtdbcpostgres1.1.7.so
/V3/usr/lib64/thread2.8.9/libthread2.8.9.so
/usr/lib64/itcl4.2.4/libitcl4.2.4.so
/usr/lib64/libtcl.so
/usr/lib64/libtcl8.6.so
/usr/lib64/sqlite3.44.2/libsqlite3.44.2.so
/usr/lib64/tdbc1.1.7/libtdbc1.1.7.so
/usr/lib64/tdbcmysql1.1.7/libtdbcmysql1.1.7.so
/usr/lib64/tdbcodbc1.1.7/libtdbcodbc1.1.7.so
/usr/lib64/tdbcpostgres1.1.7/libtdbcpostgres1.1.7.so
/usr/lib64/thread2.8.9/libthread2.8.9.so
...
/usr/share/package-licenses/tcl/233f44af3fb55dcc7fddfef8e77ac627b0008756
